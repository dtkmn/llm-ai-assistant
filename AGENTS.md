...
- `src/ai_loop_runtime.py`: current runtime implementation module during the
  refactor. It owns ingestion, encoding detection, embeddings, vector search,
