...
- `src/document_ingestion.py`: document validation, PDF/DOCX/text loading, text
  encoding detection, chunking, truncation, and chunk metadata assignment.
